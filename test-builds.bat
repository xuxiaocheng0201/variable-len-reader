...
cargo build --no-default-features --features "sync_full,bytes-comp"
cargo build --no-default-features --features "std,sync_full,bytes-comp"
...
cargo build --no-default-features --features "async_full,bytes-comp"
cargo build --no-default-features --features "tokio,async_full,bytes-comp"
