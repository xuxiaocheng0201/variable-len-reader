...
cargo build --no-default-features --features "std-comp,sync_full"
cargo build --no-default-features --features "sync_full,bytes"
cargo build --no-default-features --features "std-comp,sync_full,bytes"
...
cargo build --no-default-features --features "tokio-comp,async_full"
cargo build --no-default-features --features "async_full,bytes"
cargo build --no-default-features --features "tokio-comp,async_full,bytes"

cargo build
cargo test --no-default-features --features "full,bytes"
