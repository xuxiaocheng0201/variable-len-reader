...
#[cfg(any(feature = "sync_raw", feature = "sync_varint", feature = "sync_signed"))]
macro_rules! test_func {
...
#[cfg(any(feature = "sync_raw", feature = "sync_float"))]
...
mod varint {
    ...
    #[cfg(all(feature = "sync_varint_size", feature = "sync_long_varint"))]
...
#[cfg(feature = "sync_signed")]
mod signed {
    use crate::{VariableReader, VariableWriter};

    #[cfg(feature = "sync_long_signed")]
    ...
    #[cfg(all(feature = "sync_varint_size", feature = "sync_long_signed"))]
