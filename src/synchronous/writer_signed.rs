macro_rules! write_signed {
    (varint, $primitive: ty, $func: ident, $write_internal: ident) => {
        write_signed!(cfg(feature = "sync_signed_varint"), $primitive, $func, $write_internal);
    };
    (long_varint, $primitive: ty, $func: ident, $write_internal: ident) => {
        write_signed!(cfg(feature = "sync_signed_varint_long"), $primitive, $func, $write_internal);
    };
...
macro_rules! write_signed_size {
    (varint, $func: ident, $write_internal: ident) => {
        write_signed_size!(cfg(all(feature = "sync_varint_size", feature = "sync_signed_varint")), $func, $write_internal);
    };
    (long_varint, $func: ident, $write_internal: ident) => {
        write_signed_size!(cfg(all(feature = "sync_varint_size", feature = "sync_signed_varint_long")), $func, $write_internal);
    };
