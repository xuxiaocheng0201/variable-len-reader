...
#[cfg_attr(docsrs, doc(cfg(all(feature = "async_varint_size", feature = "async_signed"))))]
...
macro_rules! define_read_signed_futures {
    () => {
        ...
        #[cfg_attr(docsrs, doc(cfg(feature = "async_long_signed")))]
        ...
        #[cfg_attr(docsrs, doc(cfg(all(feature = "async_varint_size", feature = "async_long_signed"))))]
